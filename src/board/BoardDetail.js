...
function BoardDetail({ match, history }) {
    ...
    const handlerClickUpdate = () => {
        axios.put(`${process.env.REACT_APP_BOARD_API_URL}/board/${boardIdx}`,
                    { "title": title, "contents": contents, "updatedId": "tester", "boardIdx": boardIdx })
            .then(response => {
...
// //     const handlerClickUpdate = () => {
// //         axios.put(`${process.env.REACT_APP_REST_API_SERVER_IP}:${process.env.REACT_APP_REST_API_SERVER_PORT}/api/board/${board.boardIdx}`,
// //                     { "title": title, "contents": contents })
// //             .then(response => {
// //                 if (response.data === 1) {
// //                     alert('정상적으로 수정되었습니다.');
...
// //     const handlerClickDelete = () => {
// //         axios.delete(`${process.env.REACT_APP_REST_API_SERVER_IP}:${process.env.REACT_APP_REST_API_SERVER_PORT}/api/board/${board.boardIdx}`)
// //             .then(response => {                                         
// //                 if (response.data === 1) {                              
// //                     alert('정상적으로 삭제되었습니다.');
// //                     history.push('/board');
